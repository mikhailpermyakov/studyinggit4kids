...
public class Bitwise {
	public static void main(String[] args){
		...
		System.out.println("Флаг 1: "+ (fs&1));
		System.out.println("Флаг 2: "+ (fs&2));
		System.out.println("Флаг 3: "+ (fs&4));
		System.out.println("Флаг 4: "+ (fs&8));
		System.out.println("Флаг 5: "+ (fs&16));
		System.out.println("Флаг 6: "+ (fs&32));
		System.out.println("Флаг 7: "+ (fs&64));
		System.out.println("Флаг 8: "+ (fs&128));
	}
